package com.tp034766.arusermanual.model3D.services;
...
import com.tp034766.arusermanual.util.url.android.Handler;
		...
		if (parent.getParamFile() != null || parent.getParamAssetDir() != null) {
			...
			try {
				if (parent.getParamFile() != null) {
					...
					url = new URL("file:///android_asset/assets/" + parent.getParamAssetDir() + File.separator + parent.getParamAssetFilename());
                    //url = new URL("file:///android_asset/assets/models/ship.obj");
				}
